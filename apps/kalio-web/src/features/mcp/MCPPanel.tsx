...
/** Strip the canonical `mcp_{serverKey}_` prefix that the backend adds to tool names. */
function cleanToolName(toolName: string, serverKey: string): string {
  const prefix = `mcp_${serverKey}_`;
