...
@Module({
  ...
  providers: [HitlConfigService, HitlDecisionService, HitlNotificationService, HitlPolicyService, SecurityPolicyService],
  exports: [HitlConfigService, HitlDecisionService, HitlNotificationService, HitlPolicyService, SecurityPolicyService],
})
