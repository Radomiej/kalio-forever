...
@Module({
  ...
  providers: [ExecutionProfileService, CodexAppServerHost, CodexAppServerLLMSource, ClaudeAgentSdkLLMSource, NativeApprovalService, CodexMcpPolicyService],
  exports: [ExecutionProfileService, CodexAppServerHost, CodexAppServerLLMSource, ClaudeAgentSdkLLMSource, NativeApprovalService, CodexMcpPolicyService],
})
