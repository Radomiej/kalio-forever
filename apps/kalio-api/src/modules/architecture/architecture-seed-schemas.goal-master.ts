...
export const GOAL_MASTER_DELIVERY_LOOP: ArchitectureSchema = {
  ...
  nodes: [
    { id: 'orchestrator', label: 'Orchestrator', kind: 'router', roleSlotId: 'orchestrator', behavior: { mode: 'choose_one', fanOut: 'sequential', scoringPolicy: 'risk', description: 'Start with implementation, or route to a different node through routerOutput.nextAction="route_to" and routerOutput.targetNodeId.' }, x: 360, y: 40 },
    ...
    { id: 'goal-master', label: 'Goal Master', kind: 'router', roleSlotId: 'goal_master', behavior: { mode: 'choose_one', fanOut: 'sequential', scoringPolicy: 'confidence', description: 'Choose final-artifact when acceptance evidence is complete; set routerOutput.nextAction="route_to" and routerOutput.targetNodeId="implementer" to continue.' }, x: 360, y: 560 },
  ...
  edges: [
    ...
    { id: 'goal-master-final', fromNodeId: 'goal-master', toNodeId: 'final-artifact', label: 'goal complete', selection: 'default' },
    { id: 'goal-master-implementer', fromNodeId: 'goal-master', toNodeId: 'implementer', label: 'continue', selection: 'continuation', returnToOrchestrator: true },
  ],
