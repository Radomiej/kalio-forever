...
export const ARCHITECTURE_DEBATE: ArchitectureSchema = {
  ...
  nodes: [
    { id: 'orchestrator', label: 'Orchestrator', kind: 'router', roleSlotId: 'orchestrator', behavior: { mode: 'fan_out_all', fanOut: 'parallel', scoringPolicy: 'risk', description: 'Fan out to debate roles.' }, x: 360, y: 40 },
    ...
    { id: 'synthesizer', label: 'Synthesizer', kind: 'router', roleSlotId: 'synthesizer', behavior: { mode: 'rank_then_merge', fanOut: 'sequential', scoringPolicy: 'confidence', description: 'Rank evidence and merge the decision.' }, x: 360, y: 340 },
  ...
  edges: [
    ...
    { id: 'researcher-synthesizer', fromNodeId: 'researcher', toNodeId: 'synthesizer', selection: 'converge' },
    { id: 'pragmatist-synthesizer', fromNodeId: 'pragmatist', toNodeId: 'synthesizer', selection: 'converge' },
    { id: 'user-advocate-synthesizer', fromNodeId: 'user-advocate', toNodeId: 'synthesizer', selection: 'converge' },
    { id: 'synthesizer-final', fromNodeId: 'synthesizer', toNodeId: 'final-artifact', selection: 'converge' },
  ],
...
export const CODING_REVIEW: ArchitectureSchema = {
  ...
  nodes: [
    { id: 'orchestrator', label: 'Orchestrator', kind: 'router', roleSlotId: 'orchestrator', behavior: { mode: 'choose_one', fanOut: 'sequential', scoringPolicy: 'risk', description: 'Start or route the coding loop.' }, x: 360, y: 40 },
    ...
    { id: 'release-guard', label: 'Release Guard', kind: 'router', roleSlotId: 'release_guard', behavior: { mode: 'choose_one', fanOut: 'sequential', scoringPolicy: 'confidence', description: 'Route back to implementer until evidence proves completion.' }, x: 360, y: 560 },
  ...
  edges: [
    { id: 'orchestrator-implementer', fromNodeId: 'orchestrator', toNodeId: 'implementer', selection: 'default' },
    ...
    { id: 'release-guard-final', fromNodeId: 'release-guard', toNodeId: 'final-artifact', label: 'accepted', selection: 'default' },
    { id: 'release-guard-implementer', fromNodeId: 'release-guard', toNodeId: 'implementer', label: 'fix required', selection: 'continuation', returnToOrchestrator: true },
  ],
...
export const DEEP_RESEARCH_FLOW: ArchitectureSchema = {
  ...
  nodes: [
    { id: 'research-fanout', label: 'Research Fan-out', kind: 'parallel', behavior: { mode: 'fan_out_all', fanOut: 'parallel', scoringPolicy: 'confidence', description: 'Run technical and repo research in parallel.' }, x: 360, y: 40 },
  ...
  edges: [
    ...
    { id: 'technical-critic', fromNodeId: 'technical-research', toNodeId: 'critic', selection: 'converge' },
    { id: 'repo-critic', fromNodeId: 'repo-research', toNodeId: 'critic', selection: 'converge' },
...
export const RELEASE_GUARD: ArchitectureSchema = {
  ...
  nodes: [
    ...
    { id: 'release-guard', label: 'Release Guard', kind: 'router', roleSlotId: 'release_guard', behavior: { mode: 'choose_one', fanOut: 'sequential', scoringPolicy: 'risk', description: 'Reject unless all evidence supports release.' }, x: 360, y: 240 },
  ...
  edges: [
    ...
    { id: 'release-guard-final', fromNodeId: 'release-guard', toNodeId: 'final-artifact', selection: 'default' },
  ],
  routerPolicy: { mode: 'evidence_first', mustAddressCriticFindings: true, canReturnNeedsMoreResearch: true },
